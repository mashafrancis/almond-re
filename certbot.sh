...
#
# If the environment variable TEST CERT is defined, this script
...
# certs without running into LetsEncrypt limits. It's advisable to define TEST CERT
# when initially bringing up the container.  Once the logs (docker logs <container name>)
# show that LetsEncrypt is working fine, then remove TEST CERT environment variable
