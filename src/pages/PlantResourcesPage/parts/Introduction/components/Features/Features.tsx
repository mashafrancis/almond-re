...
const Features = ({ className, ...rest }: any): JSX.Element => {
			...
			<List>
				<ListItem disableGutters>
					...
					<Typography variant="body1" color="textPrimary">
						More than 45 pages, 300+ component reusable compositions and 30+
						stand-alone components created by following the Atomic Design
						Methodology
					</Typography>
				</ListItem>
				<ListItem disableGutters>
					...
					<Typography variant="body1" color="textPrimary">
						create-react-app & react-scripts support. NextJS & GatsbyJS server
				...
				<ListItem disableGutters>
					...
					<Typography variant="body1" color="textPrimary">
						Image lazy loading support. Animated sections on scroll. Swiper
						support
					</Typography>
				</ListItem>
				<ListItem disableGutters>
					...
					<Typography variant="body1" color="textPrimary">
						Fully responsive on all modern browsers. Figma and Sketch design
						files (available in Standard Plus & Extended licences)
					</Typography>
				</ListItem>
				<ListItem disableGutters>
					<ListItemAvatar>
