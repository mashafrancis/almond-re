...
export const TOGGLE_PUMP_STATUS_REQUEST = 'almond/timeSchedules/TOGGLE_PUMP_STATUS_REQUEST';
export type TOGGLE_PUMP_STATUS_REQUEST = typeof TOGGLE_PUMP_STATUS_REQUEST;

export const TOGGLE_PUMP_STATUS_SUCCESS = 'almond/timeSchedules/TOGGLE_PUMP_STATUS_SUCCESS';
export type TOGGLE_PUMP_STATUS_SUCCESS = typeof TOGGLE_PUMP_STATUS_SUCCESS;

export const TOGGLE_PUMP_STATUS_FAILURE = 'almond/timeSchedules/TOGGLE_PUMP_STATUS_FAILURE';
export type TOGGLE_PUMP_STATUS_FAILURE = typeof TOGGLE_PUMP_STATUS_FAILURE;

export const GET_PUMP_STATUS_REQUEST = 'almond/timeSchedules/GET_PUMP_STATUS_REQUEST';
export type GET_PUMP_STATUS_REQUEST = typeof GET_PUMP_STATUS_REQUEST;

export const GET_PUMP_STATUS_SUCCESS = 'almond/timeSchedules/GET_PUMP_STATUS_SUCCESS';
export type GET_PUMP_STATUS_SUCCESS = typeof GET_PUMP_STATUS_SUCCESS;

export const GET_PUMP_STATUS_FAILURE = 'almond/timeSchedules/GET_PUMP_STATUS_FAILURE';
