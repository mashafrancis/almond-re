  ...
  describe('Create new schedule thunk', () => {
    ...
    it('should display snack error message on network error', () => {
      const mockErrorResponse = {
        response: {
          data: {
            message: 'An error occurred while creating your request. Please try again',
          },
        },
      };
      const expectedActions = [
  ...
  describe('Delete schedule thunk', () => {
    ...
    it('should display snack error message on network error', () => {
      const mockErrorResponse = {
        response: {
          data: {
            message: 'An error occurred while deleting your schedule. Please try again',
          },
        },
      };
      const expectedActions = [
  ...
  describe('Editing a schedule thunk', () => {
    ...
    it('should display snack error message on network error', () => {
      const mockErrorResponse = {
        response: {
          data: {
            message: 'An error occurred while editing your schedule. Please try again',
          },
        },
      };
      const expectedActions = [
  ...
  describe('Get pump status thunk', () => {
    ...
    it('should display snack error message on network error', () => {
      const mockErrorResponse = {
        response: {
          data: {
            message: 'An error occurred while fetching pump status. Please try again',
          },
        },
      };
      const expectedActions = [
