...
export const DELETE_USER_ROLES_REQUEST = 'almond/user-roles/DELETE_USER_ROLES_REQUEST';
...
export const DELETE_USER_ROLES_FAILURE = 'almond/user-roles/DELETE_USER_ROLES_FAILURE';
export type DELETE_USER_ROLES_FAILURE = typeof DELETE_USER_ROLES_FAILURE;

export const EDIT_USER_ROLES_REQUEST = 'almond/user-roles/EDIT_USER_ROLES_REQUEST';
...
export const EDIT_USER_ROLES_FAILURE = 'almond/user-roles/EDIT_USER_ROLES_FAILURE';
