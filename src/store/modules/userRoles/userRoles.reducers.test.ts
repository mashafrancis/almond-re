...
describe('User roles reducer:', () => {
  ...
  describe('Get user roles', () => {
    it('should dispatch GET_USER_ROLES_REQUEST', () => {
      ...
      const userRolesState = reducer(userRoleInitialState, getUserRolesRequestAction);
    ...
    it('should dispatch GET_USER_ROLES_SUCCESS', () => {
      ...
      const userRolesState = reducer(userRoleInitialState, getUserRolesSuccessAction);
    ...
    it('should dispatch GET_USER_ROLES_FAILURE', () => {
      ...
      const userRolesState = reducer(userRoleInitialState, getUserRolesFailureAction);
  ...
  describe('Create user roles', () => {
    it('should dispatch CREATE_USER_ROLES_REQUEST', () => {
      ...
      const userRolesState = reducer(userRoleInitialState, createUserRolesRequestAction);
    ...
    it('should dispatch CREATE_USER_ROLES_SUCCESS', () => {
      const createUserRolesSuccessAction = createUserRoleSuccess(newUserRole as any);
      const userRolesState = reducer(userRoleInitialState, createUserRolesSuccessAction);

      expect(userRolesState.isLoading).toBeFalsy();
      expect(userRolesState.roles[0].description).toBe('Almond regular user with limited privileges');
      expect(userRolesState.errors).toBe(null);
    });

    it('should dispatch CREATE_USER_ROLES_FAILURE', () => {
      const createUserRolesFailureAction = createUserRoleFailure(errorMessage);
      const userRolesState = reducer(userRoleInitialState, createUserRolesFailureAction);
  ...
  describe('Edit user role', () => {
    it('should dispatch EDIT_USER_ROLES_REQUEST', () => {
      ...
      const userRolesState = reducer(userRoleInitialState, editUserRoleRequestAction);
    ...
    it('should dispatch EDIT_USER_ROLES_SUCCESS', () => {
      ...
      const editUserRolesSuccessAction = editUserRoleSuccess(userRoleToUpdate, userRoleToUpdate._id);
      const userRolesState = reducer(userRoleInitialState, editUserRolesSuccessAction);
    ...
    it('should dispatch EDIT_USER_ROLES_FAILURE', () => {
      ...
      const userRolesState = reducer(userRoleInitialState, editUserRolesFailureAction);
  ...
  describe('Delete user role', () => {
    it('should dispatch DELETE_USER_ROLES_REQUEST', () => {
      ...
      const userRolesState = reducer(userRoleInitialState, deleteUserRoleRequestAction);
    ...
    it('should dispatch DELETE_USER_ROLES_SUCCESS', () => {
      ...
      const deleteUserRolesSuccessAction = deleteUserRolesSuccess('5e4703d62faee61d8ede2d65');
      const userRolesState = reducer(userRoleInitialState, deleteUserRolesSuccessAction);
