...
describe('People reducer:', () => {
  ...
  describe('Get people', () => {
    it('should dispatch GET_ALL_PEOPLE_SUCCESS', () => {
      const getPeopleSuccessAction = getAllPeopleSuccess(peopleResponse.data as any);
  ...
  describe('Update person', () => {
    ...
    it('should dispatch UPDATE_PERSON_DETAILS_SUCCESS', () => {
      const updatePersonSuccessAction = updatePersonSuccess(personToUpdate as any);
      const peopleState = reducer(peopleInitialState as any, updatePersonSuccessAction);
    ...
    it('should dispatch UPDATE_PERSON_DETAILS_FAILURE', () => {
      ...
      const peopleState = reducer(peopleInitialState as any, updatePersonFailureAction);
