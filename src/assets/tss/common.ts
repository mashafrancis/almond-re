...
const primaryBoxShadow = {
	boxShadow:
		'0 12px 20px -10px rgba(25, 103, 210, 0.28), 0 4px 20px 0px rgba(0, 0, 0, 0.12), 0 7px 8px -5px rgba(25, 103, 210, 0.2)',
};
const infoBoxShadow = {
	boxShadow:
...
const title = {
	...
	textDecoration: 'none',
	fontWeight: '400',
	fontFamily: `"Product Sans", "Roboto", "Helvetica Neue", sans-serif`,
};
